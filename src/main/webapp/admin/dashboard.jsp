    ...
    <div class="content-scroll">
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-value">
                    <fmt:formatNumber value="${not empty totalSales ? totalSales : 0}" pattern="#,##0.00" /> dh
                </div>
            </div>
            <div class="stat-card">
                <div class="stat-title">Orders</div>
                <div class="stat-value">${not empty orderCount ? orderCount : 0}</div>
            </div>
            <div class="stat-card">
                <div class="stat-title">Products</div>
                <div class="stat-value">${not empty productCount ? productCount : 0}</div>
            </div>
            <div class="stat-card">
                <div class="stat-title">Customers</div>
                <div class="stat-value">${not empty customerCount ? customerCount : 0}</div>
            </div>
        </div>
        ...
        <div class="table-container">
            <div class="table-header">
                <h3>Recent Orders</h3>
                <button class="btn-primary" onclick="window.location.href='${pageContext.request.contextPath}/admin/orders'">View All</button>
            </div>
            <table>
                <thead>
                <tr>
                    ...
                    <c:when test="${not empty topProducts}">
                        <c:forEach var="prod" items="${topProducts}">
                            <tr>
                                ...
                                <td><fmt:formatNumber value="${prod.price}" pattern="#,##0.00" /> dh</td>
                            </tr>
                        </c:forEach>
                    </c:when>
                    <c:otherwise>
                        <tr class="empty-row"><td colspan="2">No sales data available.</td></tr>
                    </c:otherwise>
                </c:choose>
                </tbody>
            </table>
